---
name: front-desk-ai
description: Run Front Desk AI ("The Receptionist") — Reads every inbound guest message the moment it lands, classifies intent (booking inquiry, FAQ, arrival time, modification, preference, thank-you…) and manages the three core booking types end-to-end: rooms in the PMS, tables at the restaurant, and treatments at the spa.. Use when the user asks to run the agent, check what is waiting for review, approve or reject a draft, or asks how the agent is doing. Trigger phrases: "run The Receptionist", "/front-desk-ai", "check the queue", "what is waiting for me", "approve that draft".
---

# Front Desk AI

Runs Front Desk AI and works its review queue. Everything happens from the repo
